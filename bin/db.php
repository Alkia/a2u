<?php
 ...
 class connectToDB
 {
	...
	public function addEvent( $company, $details, $latitude, $longitude, $telephone, $keywords, $eventday, $authorizationkey, $guid, $devicedate )
	{
		//echo "<hh> done :". $keywords."|".$eventday."|";
		  $statement = $this->conn->prepare("INSERT INTO companies( company, details, latitude, longitude, telephone, keywords,  devicedate, guid, authorizationkey, eventday ) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
	      $statement->bind_param('ssssssssss', $company, $details, $latitude, $longitude, $telephone, $keywords,$devicedate,$guid,$authorizationkey,$eventday);
